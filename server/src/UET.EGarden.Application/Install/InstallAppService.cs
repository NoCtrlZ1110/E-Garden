...
namespace UET.EGarden.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : EGardenAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<EGardenDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(EGardenConsts.ConnectionStringName).Value.ToString();
        }
