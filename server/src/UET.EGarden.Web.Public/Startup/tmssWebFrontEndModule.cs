...
namespace UET.EGarden.Web.Public.Startup
{
    ...
    public class EGardenWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public EGardenWebFrontEndModule(IWebHostEnvironment env, EGardenEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EGardenWebFrontEndModule).GetAssembly());
        }
    }
}
