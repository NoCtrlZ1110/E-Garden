...
using UET.EasyAccommod.Web.Models.Account;
using UET.EasyAccommod.Web.Views.Shared.Components.TenantChange;

namespace UET.EasyAccommod.Web.Controllers
{
    public class AccountController : EasyAccommodControllerBase
    {
