...
namespace UET.EGarden.EntityFrameworkCore.Repositories
{
    ...
    /// <summary>
    /// Base class for custom repositories of the application.
    /// This is a shortcut of <see cref="EGardenRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class EGardenRepositoryBase<TEntity> : EGardenRepositoryBase<TEntity, int>, IRepository<TEntity>
