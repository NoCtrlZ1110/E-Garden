...
using UET.EGarden.EntityFrameworkCore.Repositories;

namespace UET.EGarden.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : EGardenRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<EGardenDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
