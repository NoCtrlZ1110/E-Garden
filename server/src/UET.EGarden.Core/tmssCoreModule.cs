...
using UET.EGarden.Authorization.Ldap;
...
using UET.EGarden.DynamicEntityParameters;
...
using UET.EGarden.WebHooks;

namespace UET.EGarden
{
    [DependsOn(
        typeof(EGardenCoreSharedModule),
    ...
    public class EGardenCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, EGardenMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<EGardenSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
