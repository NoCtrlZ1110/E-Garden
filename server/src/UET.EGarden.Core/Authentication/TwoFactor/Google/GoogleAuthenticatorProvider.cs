...
namespace UET.EGarden.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : EGardenServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("UET.EGarden", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
